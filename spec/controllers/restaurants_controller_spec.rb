...
describe RestaurantsController do
  ...
  describe "GET #new" do
    ...
    it "renders the new template if user signs in" do
    ...
    it "assigns a new restaurant if user signs in" do
      user = FactoryGirl.create(:user)
      sign_in user
      get :new 
    ...
    it "should redirect to the sign in page if user does not sign in" do
      get :new 
  ...
  describe "POST #create" do
    ...
    it "should create a restaurant if user signs in" do
      user = FactoryGirl.create(:user)
      sign_in user
    ...
    it "should render template new if user signed in but there were any invalid params" do
      user = FactoryGirl.create(:user)
      sign_in user
  ...
  describe "GET #edit" do
    it "should edit a restaurant if the user of that restaurant is signed in" do
      user = FactoryGirl.create(:user)
      sign_in user
  ...
  describe "PATCH #update" do
    it "should direct to an updated page if the user of that restaurant signs in" do
      user = FactoryGirl.create(:user)
      sign_in user
      restaurant = FactoryGirl.create(:restaurant, user: user)    
